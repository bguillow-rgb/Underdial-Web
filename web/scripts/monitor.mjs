...
//
// Usage: node scripts/monitor.mjs --url https://underdial.com
...
const SITE = (urlArg || process.env.SITE_URL || 'https://underdial.com').replace(/\/$/, '');
const CERT_WARN_DAYS = Number(process.env.CERT_WARN_DAYS || 21);
const MAX_CONCURRENCY = 8;
const UA = 'Underdial-Monitor/1.0 (+health-check)';
