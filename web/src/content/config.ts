...
const articles = defineCollection({
  ...
  schema: z.object({
    ...
    faqs: z
      ...
      .default([]),
    // True when the article body contains retailer affiliate links.
    // ArticleLayout renders the FTC disclosure above the body and turns
    // on outbound click tracking.
